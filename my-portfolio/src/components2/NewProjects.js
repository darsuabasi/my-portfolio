        ...
        <Container fluid className="projectMain">
            <Row className="subContain">
                    ...
                    <CardDeck sm={4} className="allTheCards"> 
                        <div className="projectThree">
                            ...
                            <div class="image__overlay image__overlay--primary">
                                ...
                                <a style={{fontVariant:'small-caps', fontSize:'28px'}} className="image__link" href="https://github.com/darsuabasi/now-thats-cap" target="_blank"> The Code </a> 
                ...
                <div className="projectTwo">
                    <a href="https://github.com/darsuabasi/AllAboutTheGreen" target="_blank">
                    ...
                    <div class="image__overlay image__overlay--primary">
                        ...
                        <a style={{fontVariant:'small-caps', fontSize:'28px'}} className="image__link" href="https://github.com/darsuabasi/AllAboutTheGreen" target="_blank"> The Code </a>
