                ...
                <CardDeck sm={4} className="allTheCards"> 
                    <Card className="fullCard" style={{height: '30rem', width: '24rem'}}>
                        ...
                        <Card.Body>
                            ...
                            <button className="linkButtons appLink" href="https://zoovio.netlify.app/"> Keep Track of Your Pets! </button>
                            <button className="linkButtons appLink"  href="https://github.com/darsuabasi/zoovio"> Check out the code! </button>
                        </Card.Body>
                    </Card>
                {/* </Col> */}
